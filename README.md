...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/angular-cli-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/angular-cli-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add angular-cli
# for installing globally
pixi global install angular-cli
```
...
It is possible to list all of the versions of `angular-cli` available on your platform:
...
```
pixi search angular-cli --channel conda-forge
```
